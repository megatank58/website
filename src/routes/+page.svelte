...
<div class="hero bg-base-200 min-h-screen">
	<div class="hero-content text-left">
		<div class="max-w-md">
			<h1 class="my-3 text-pretty text-5xl font-bold">
				Megatank58
			...
			<div class="flex flex-row pt-2">
				...
				<a class="btn bg-base-300 rounded-full" href="/blogs"
					>Blog<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24"
						><path
							fill="currentColor"
